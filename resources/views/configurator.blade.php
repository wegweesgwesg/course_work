...
@section('title', 'Конфигуратор ПК — bit.sp')
...
<main class="config-page" role="main" aria-labelledby="config-title">
        ...
        <div id="categories-list">
            ...
            <div class="category" id="cat-{{ $catId }}">
                <div class="category-header" data-target="{{ $catId }}">
                    <div class="title">{{ $cat['title'] }} <span class="slot-counter" id="slot-counter-{{ $catId }}"></span></div>
                    <div class="toggle">▾</div>
                </div>
                <div class="category-body">
                    <div class="category-slots" id="slots-{{ $catId }}" data-category="{{ $catId }}">
    ...
    <aside class="config-right" aria-label="Итоговая панель">
        ...
        <div class="configs-section">
            <a href="{{ route('builds.index') }}" class="builds-catalog-link">
